...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FHSTwitterEngine/FHSTwitterEngine.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ILTranslucentView/ILTranslucentView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KILabel/KILabel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LPSnackbar/LPSnackbar.framework"
